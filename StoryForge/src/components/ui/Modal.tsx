  ...
  return createPortal(
    ...
    >
      <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        {/* Modal Panel */}
        <div
          className={`relative z-10 inline-block align-bottom bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle w-full ${maxWidthClasses[maxWidth]} border border-gray-700`}
        >
          {title && (
