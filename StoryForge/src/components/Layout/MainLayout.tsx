        ...
        <div className="min-h-screen flex flex-col bg-gray-50 text-gray-900">
            ...
            <header className="bg-white border-b border-gray-200 h-16 flex items-center px-6 shadow-sm z-10">
                ...
                <nav className="ml-auto flex gap-4">
                    ...
                    <a href="#" className="text-gray-600 hover:text-indigo-600 transition-colors">Projects</a>
            ...
            <div className="flex flex-1 overflow-hidden">
                ...
                <aside className="w-64 bg-white border-r border-gray-200 hidden md:flex flex-col p-4">
                    ...
                    <ul className="space-y-2">
                        <li className="p-2 rounded hover:bg-gray-100 cursor-pointer text-sm font-medium text-gray-700">Dashboard</li>
                        <li className="p-2 rounded hover:bg-gray-100 cursor-pointer text-sm font-medium text-gray-700">My Stories</li>
                        <li className="p-2 rounded hover:bg-gray-100 cursor-pointer text-sm font-medium text-gray-700">Characters</li>
                        <li className="p-2 rounded hover:bg-gray-100 cursor-pointer text-sm font-medium text-gray-700">World Building</li>
                    </ul>
                </aside>
                ...
                <aside className="w-72 bg-white border-l border-gray-200 hidden lg:flex flex-col p-4">
                    <div className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-4">Tools & Context</div>
